...
namespace Unity.XR.PXR
{
    public class PXR_EyeTracking
    {
        ...
        /// <summary>
        /// Get the origin of left eye gaze point (This interface is only available for Neo 2 Eye and Neo3 Pro).
        /// </summary>
        /// <param name="point">Receive the vector 3 returned by the result</param>
        /// <returns>True - succeed, false - failed</returns>
        public static bool GetLeftEyeGazePoint(out Vector3 point)
        {
            ...
            {
                Debug.LogError("PXRLog Failed at GetLeftEyeGazePoint point");
                return false;
            }
        ...
        /// <summary>
        /// Get the origin of Left eye gaze Vector (This interface is only available for Neo 2 Eye and Neo3 Pro).
        /// </summary>
        /// <param name="vector">Receive the vector 3 returned by the result</param>
        /// <returns>True - succeed, false - failed</returns>
        public static bool GetLeftEyeGazeVector(out Vector3 vector)
        {
            ...
            {
                Debug.LogError("PXRLog Failed at GetLeftEyeGazeVector vector");
                return false;
            }
        ...
        public static bool GetRightEyeGazePoint(out Vector3 point)
        {
            ...
            {
                Debug.LogError("PXRLog Failed at GetRightEyeGazePoint point");
                return false;
            }
        ...
        /// <summary>
        /// Get the origin of Right eye gaze Vector (This interface is only available for Neo 2 Eye and Neo3 Pro).
        /// </summary>
        /// <param name="vector">Receive the vector 3 returned by the result</param>
        /// <returns>True - succeed, false - failed</returns>
        public static bool GetRightEyeGazeVector(out Vector3 vector)
        {
            ...
            {
                Debug.LogError("PXRLog Failed at GetRightEyeGazeVector vector");
                return false;
            }
        ...
        /// <summary>
        /// Get left eye PupilDilation (This interface is only available for Neo 2 Eye and Neo3 Pro).
        /// </summary>
        /// <param name="value">Receive the float returned by the result</param>
        /// <returns>True - succeed, false - failed</returns>
        public static bool GetLeftEyePupilDilation(out float value)
        {
            ...
            {
                Debug.LogError("PXRLog Failed at GetLeftEyePupilDilation value");
                return false;
            }
            return true;
        }
        ...
        /// <summary>
        /// Get right eye PupilDilation (This interface is only available for Neo 2 Eye and Neo3 Pro).
        /// </summary>
        /// <param name="value">Receive the float returned by the result</param>
        /// <returns>True - succeed, false - failed</returns>
        public static bool GetRightEyePupilDilation(out float value)
        {
            ...
            {
                Debug.LogError("PXRLog Failed at GetRightEyePupilDilation value");
                return false;
            }
            return true;
        }
